  ...
  return (
    ...
    >
      ...
      <div className=" androidPhones:space-x-2 py-1 lg:ml-2 mr-3 lg:space-x-4 flex items-center">
        ...
        >
          <p className="flex androidPhones:w-full androidPhones:h-full lg:w-auto items-center font-semibold lg:gap-1 androidPhones:p-2 lg:py-2 lg:px-5 outline-none tracking-[0.5px] rounded-md bg-[#fb663d] border-[#fb663d] text-white">
            <AiOutlineShoppingCart className="align-middle italic w-[15px] h-[15px]" />
            <span className="androidPhones:hidden lg:block">Download</span>
          </p>
        </a>
      </div>
    </motion.div>
